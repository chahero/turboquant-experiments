...
# Default model - can be overridden by command line
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="TurboQuant validation on any model")
    parser.add_argument("--model", type=str, default=None, help="Model name (e.g., Qwen/Qwen2.5-3B-Instruct)")
